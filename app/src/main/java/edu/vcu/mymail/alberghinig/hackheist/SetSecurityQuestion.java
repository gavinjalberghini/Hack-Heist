...
public class SetSecurityQuestion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText securityQuestion = findViewById(R.id.SecurityQuestionBox);
        final EditText securityQuestionAnswer = findViewById(R.id.SecurityAnswerBox);
        final EditText password = findViewById(R.id.PasswordEntryBox);
