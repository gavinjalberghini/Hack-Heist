...
$query = 'UPDATE '.USER_TABLE.' SET Security_Question = \''.$decodedContent["Security_Question"].'\', Security_Question_Answer = \''.$decodedContent["Security_Question_Answer"].'\', Password = \''.$decodedContent["Password"].'\' WHERE ID = '.$decodedContent["ID"];
//echo $query;
